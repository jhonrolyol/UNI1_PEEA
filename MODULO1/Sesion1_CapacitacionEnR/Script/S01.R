...
setwd("C:/Users/GAMER/Desktop/Economia/ProramasDeEspecializacion/ProgramaDeEspecializacionEnEconometriaAplicada_UNI/CarpetasModulo_I/CapacitacionEnR/Script")
...
B
  ...
  solve(D) # Se calcula de esta forma la matriz inversa
...
# Gráfico combinado
?par
par(mfrow = c(1,2)) # Se usa en la insertación de gráficas
...
par(mfrow = c(1,1)) # Se usa en la insertación de gráficas
